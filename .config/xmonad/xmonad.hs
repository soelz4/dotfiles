...
main :: IO ()
main = do
  -- Launching Instance of Xmobar on their Monitors.
  xmproc <- spawnPipe "xmobar -x 0 ~/.config/xmobar/xmobarrc"
  xmonad $ docks $ ewmhFullscreen $ ewmh $ withEasySB (statusBarProp "xmobar ~/.config/xmobar/xmobarrc" (pure myXmobarPP)) defToggleStrutsKey $ defaults
...
defaults =
  def
    ...
    `additionalKeysP` [ -- Launch FireFox
                        ("M-S-b", spawn "firefox"),
                        -- Scrot
                        ("<Print>", spawn "scrot"),
                        -- Reduce Volume
...
myXmobarPP = def
  ...
  where
    ...
    blue, lowWhite, magenta, red, white, yellow, cyan, purple, green :: String -> String
...
help =
  unlines
    [ "The default modifier key is 'alt'. Default keybindings:",
      ...
      "mod-Shift-Enter  Launch WezTerm",
      "mod-p            Launch rofi",
