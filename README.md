...
Also, There are some Additional Steps in the Installation Script that are Mentioned in the File, so Check it Before Running the File and You Can Skip those Steps.
